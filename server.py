...
def admin_photos():
    try:
        ...
        if not os.path.exists(PHOTOS_DIR):
            return "Папка photos не найдена"
        ...
        # Самые большие фотографии сверху
        ...
        <head>
            <meta charset="UTF-8">
            <title>Фото ToyShop</title>
        </head>
        <body>
            <h2>Фотографии ToyShop</h2>

            <p>Всего фотографий: {len(files)}</p>
            <p>Общий размер: {total_mb:.2f} MB</p>
